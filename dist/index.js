...
exports.greetPeopleNew = exports.greetPeopleEl = exports.greetPeople = exports.optionallyAdd = exports.printThis = exports.getPersonNameString = exports.getPersonStreet = exports.getPersonStreetNo = exports.sumEven = exports.getEvensum = exports.countm = exports.count = exports.isOld = exports.greet = void 0;
...
// Marcus his code
const sumEven = (arr) => arr.filter(num => num % 2 === 0).reduce((sum, curr) => sum + curr, 0);
...
// Notice the ...names there? That means that we would accept any number of parameters after the first argument.
const greetPeople = (greeting, ...names) => `${greeting} ${names.join(' and ')}`.trim();
exports.greetPeople = greetPeople;
// NOTE THE REPLACE, it replace the last sepeartor in any desired one. (with presets, put othter preset when neccesary)
// oude workaround
